...
$sql="Select item_name,max(A_timestamp),form_id from mainview2 where F_name='".$uname."' and form_status='Approved' and A_status=form_status and Deleted_Fac=0 GROUP BY form_id ORDER BY A_timestamp DESC";
$id=1;
