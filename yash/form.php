...
<title>Form</title>
<link href="http://max.jotfor.ms/min/g=formCss?3.1.563" rel="stylesheet"
	type="text/css" />
<style type="text/css">
.form-label {
...
<link type="text/css" rel="stylesheet"
	href="http://jotform.me/css/styles/buttons/form-submit-button-light_rounded.css?3.1.563" />
<script src="http://max.jotfor.ms/min/g=jotform?3.1.563"
...
<body>
	<form class="jotform-form" action="http://localhost/SE/en.php"
		method="post" enctype="multipart/form-data" name="form_22643568634460"
		id="22643568634460" accept-charset="utf-8">
		<div class="form-all">
				...
				<li class="form-line" id="id_9"><label class="form-label-left"
					...
					<div id="cid_9" class="form-input">
						<span class="form-sub-label-container"><input class="form-textbox"
							...
							maxlength="2" value="20" /><span class="date-separate">&nbsp;/</span>
							...
							maxlength="2" value="10" /><span class="date-separate">&nbsp;/</span>
							...
							type="text" size="4" maxlength="4" value="2012" /> <label
							...
							src="http://jotform.me/images/calendar.png" align="absmiddle" />
				...
				<li class="form-line" id="id_73"><label class="form-label-left"
					...
					<div id="cid_73" class="form-input">
						<span class="form-sub-label-container"><input type="text"
							...
							name="q73_costOf73" size="20" maxlength="5" /> <label
				...
				<li class="form-line" id="id_82"><label class="form-label-left"
					...
					<div id="cid_82" class="form-input">
						<span class="form-sub-label-container"><input type="text"
							...
							name="q82_costOf" size="20" maxlength="5" /> <label
				...
				<li class="form-line" id="id_74"><label class="form-label-left"
					...
					<div id="cid_74" class="form-input">
						<span class="form-sub-label-container"><input type="text"
							...
							name="q74_costOf74" size="20" maxlength="5" /> <label
				...
				<li class="form-line" id="id_75"><label class="form-label-left"
					...
					<div id="cid_75" class="form-input">
						<span class="form-sub-label-container"><input type="text"
							...
							name="q75_costOf75" size="20" maxlength="5" /> <label
				...
				<li class="form-line" id="id_76"><label class="form-label-left"
					...
					<div id="cid_76" class="form-input">
						<span class="form-sub-label-container"><input type="text"
							...
							name="q76_costOf76" size="20" maxlength="5" /> <label
				...
				<li class="form-line" id="id_77"><label class="form-label-left"
					...
					<div id="cid_77" class="form-input">
						<span class="form-sub-label-container"><input type="text"
							...
							name="q77_costOf77" size="20" maxlength="5" /> <label
				...
				<li class="form-line" id="id_78"><label class="form-label-left"
					...
					<div id="cid_78" class="form-input">
						<span class="form-sub-label-container"><input type="text"
							...
							name="q78_costOf78" size="20" maxlength="5" /> <label
				...
				<li class="form-line" id="id_79"><label class="form-label-left"
					...
					<div id="cid_79" class="form-input">
						<span class="form-sub-label-container"><input type="text"
							...
							name="q79_costOf79" size="20" maxlength="5" /> <label
				...
				<li class="form-line" id="id_80"><label class="form-label-left"
					...
					<div id="cid_80" class="form-input">
						<span class="form-sub-label-container"><input type="text"
							...
							name="q80_costOf80" size="20" maxlength="5" /> <label
				...
				<li class="form-line" id="id_81"><label class="form-label-left"
					...
					<div id="cid_81" class="form-input">
						<span class="form-sub-label-container"><input type="text"
							...
							name="q81_costOf81" size="20" maxlength="5" /> <label
				...
				<li class="form-line" id="id_94">
					<div id="cid_94" class="form-input-wide">
						<div style="text-align: left" class="form-buttons-wrapper">
							<button id="input_94" type="submit"
								class="form-submit-button form-submit-button-light_rounded">
								Save Draft</button>
							&nbsp;
							...
							<button id="input_print_94" style="margin-left: 25px;"
								...
								type="button">
								<img src="http://jotform.me/images/printer.png"
