...
$sql="Select item_name,A_timestamp,form_id,form_status from mainview2 where A_status=form_status and F_name='".$uname."' and Deleted_Fac=0 ORDER BY A_timestamp DESC";
$id=1;
