...
$sql="Select item_name,A_timestamp,A_reason,form_id,A_name from mainview2 where F_name='".$uname."' and form_status='Rejected' and A_present=1 and Deleted_Fac=0 ORDER BY A_timestamp DESC";
$id=1;
